...
public class ArrayTests {
	...
	public void booleanFields() {
		...
		assertTrue(CcpSimpleArrayValidations.booleanItems.isValidJson(json, fields));
	}
	...
	public void doubleFields() {
		...
		assertTrue(CcpSimpleArrayValidations.doubleItems.isValidJson(json, fields));
	}
	...
	public void integerFields() {
		...
		assertTrue(CcpSimpleArrayValidations.integerItems.isValidJson(json, fields));
	}
	...
	public void jsonFields() {
		...
		assertTrue(CcpSimpleArrayValidations.jsonItems.isValidJson(json, fields));
	}
	...
	public void listFields() {
		...
		CcpJsonRepresentation json = CcpOtherConstants.EMPTY_JSON
				...
				;
		assertTrue(CcpSimpleArrayValidations.listItems.isValidJson(json, fields));
	}
	...
	public void nonRepeatedLists() {
		...
		CcpJsonRepresentation json = CcpOtherConstants.EMPTY_JSON
				...
				;
		assertTrue(CcpSimpleArrayValidations.nonRepeatedItems.isValidJson(json, fields));
	}
	@Test
	public void notEmptyArray() {
		...
		CcpJsonRepresentation json = CcpOtherConstants.EMPTY_JSON
				...
				.put("field5","[true, false]")
				;
		assertTrue(CcpSimpleArrayValidations.notEmptyArray.isValidJson(json, fields));
	}
}
