...
public class ObjectTests {
	...
	public void booleanFields() {
		...
		assertTrue(CcpSimpleObjectValidations.booleanFields.isValidJson(json, "field1", "field2"));
	}
	...
	public void doubleFields() {
		...
		assertTrue(CcpSimpleObjectValidations.doubleFields.isValidJson(json, "field1", "field2", "field3", "field4"));
}
	...
	public void integerFields() {
		...
		assertTrue(CcpSimpleObjectValidations.integerFields.isValidJson(json, "field1", "field2", "field3", "field4"));
	}
	...
	public void jsonFields() {
		...
		assertTrue(CcpSimpleObjectValidations.jsonFields.isValidJson(json, "field1", "field2", "field3", "field4"));
	}
	...
	public void listFields() {
		...
		assertTrue(CcpSimpleObjectValidations.listFields.isValidJson(json, "field1", "field2", "field3", "field4"));
	}
	...
	public void nonRepeatedLists() {
		CcpJsonRepresentation json = CcpOtherConstants.EMPTY_JSON
				...
				;
		assertTrue(CcpSimpleObjectValidations.nonRepeatedLists.isValidJson(json, "field1", "field2", "field3", "field4", "field5"));
	}
}
