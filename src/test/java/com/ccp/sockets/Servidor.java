...
public class Servidor  implements Serializable{
	...
	public void iniciar(int porta) {
        ...
        try(ServerSocket servidor = new ServerSocket(porta, 10)) {
            ...
            while (!sair) {
                ...
                do {//fica aqui ate' o cliente enviar a mensagem FIM
                    try {
                        ...
                        saida.writeObject(new Servidor());
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 1) {
            System.err.println("Uso: java " + Servidor.class.getName() + " <porta>");
            System.exit(1);
        }
